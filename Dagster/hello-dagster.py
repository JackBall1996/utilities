...
def my_second_asset(context: AssetExecutionContext, my_first_asset: List): #Method 1 of using return from another asset 
    """
    test description
    """
...
def my_third_asset(context: AssetExecutionContext, upstream: List): #Method 2 of using return from another asset
    """
    test description
    """
    data = [7, 8, 9]
...
@asset(ins={
    ...
    group_name="my_second_group") # Using return from multiple assets
def my_forth_asset(context: AssetExecutionContext, first_upstream: List, second_upstream: List):
    """
    test description
    """
